    ...
    <section ref={containerRef} className="relative h-screen overflow-hidden">
      <div className="relative w-full h-full">{/* Video Background */}
        <div className="absolute inset-0 w-full h-full">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-black/20 via-transparent to-white/30"></div>
        </div>

        {/* Desktop Layout - Text centered, image at bottom right */}
        ...
        {/* Profile Image - Desktop: Positioned at bottom right with parallax */}
        <motion.div
          initial={{ opacity: 0, x: 50 }}
          animate={{ opacity: 1, x: 0 }}
        ...
        {/* Mobile Layout - Text and image centered vertically */}
