import svgPaths from "./svg-56x8s8q3cf";
...
function Group41() {
  return (
    <div className="absolute contents left-0 top-[781px]">
      <div className="absolute bg-black h-[22px] left-0 top-[781px] w-[360px]" />
      <div className="absolute bg-white h-[5px] left-[119px] top-[790px] w-[123px]" />
    </div>
  );
}
...
function Group2() {
  return (
    <div className="absolute h-[14.492px] left-[299px] top-[108px] w-[16.446px]" data-name="Group">
