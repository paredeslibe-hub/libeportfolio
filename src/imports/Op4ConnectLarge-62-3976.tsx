import svgPaths from "./svg-k3qoz8jeds";
  ...
  return (
    <div className="absolute left-[115px] size-[18px] top-[107px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
        <g id="Group 1203">
          <circle cx="9" cy="9" fill="var(--fill-0, #6CC24A)" id="Ellipse 102" r="9" />
          <path d={svgPaths.p31fbeb00} fill="var(--fill-0, #6CC24A)" id="Vector" stroke="var(--stroke-0, white)" />
        </g>
      </svg>
    </div>
  );
...
export default function Op4ConnectLarge() {
  return (
    <div className="bg-white overflow-visible relative rounded-[20px] size-full" data-name="Op4-Connect-Large">
      <StatusBar1 />
      <Group34 />
      <Group40 />
      <Header />
